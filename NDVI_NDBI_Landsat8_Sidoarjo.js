...
Export.image.toDrive({
  ...
  description: 'NDVI_Map_SDA_2024',
  folder: 'Data_Skripsi',
  fileNamePrefix: 'NDVI_Sidoarjo_2024',
...
Export.image.toDrive({
  ...
  description: 'NDBI_Map_SDA_2024',
  folder: 'Data_Skripsi',
  fileNamePrefix: 'NDBI_Sidoarjo_2024',
...
Export.table.toDrive({
  ...
  description: 'NDVI_export_SDA_2024',
  folder: 'Data_Skripsi',
  fileFormat: 'CSV'
});
...
Export.table.toDrive({
  ...
  description: 'NDBI_export_SDA_2024',
  folder: 'Data_Skripsi',
  fileFormat: 'CSV'
});
